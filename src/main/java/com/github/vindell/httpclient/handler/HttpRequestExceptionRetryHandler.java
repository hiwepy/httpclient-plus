 package com.github.vindell.httpclient.handler;
...
public class HttpRequestExceptionRetryHandler extends StandardHttpRequestRetryHandler {
	...
	public HttpRequestExceptionRetryHandler(final int retryCount, final boolean requestSentRetryEnabled){
	...
	public boolean retryRequest(IOException exception, int executionCount,HttpContext context) {
        ...
        return super.retryRequest(exception, executionCount, clientContext);
	}
